...
class BlogPostDAO:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            res = self.posts.update_one({"permalink": permalink}, {"$push": {"comments": comment}})
            return res.matched_count  # Change this to return the number of documents updated by the code for HW 3.3
